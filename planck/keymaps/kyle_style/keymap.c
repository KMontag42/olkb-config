...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = {
    ...
    {KC_LEAD, KC_LCTL, KC_LALT, KC_LGUI, M(1),    KC_SPC,  KC_SPC,   M(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
  },
...
void matrix_scan_user(void) {
  LEADER_DICTIONARY() {
    ...
    SEQ_TWO_KEYS(KC_E, KC_Q) {
      register_code(EMACS_RESTART);
      unregister_code(EMACS_RESTART);
    }
  }
}
